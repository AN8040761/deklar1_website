...
include("dbinfo.inc.php");
mysql_query("SET NAMES UTF8");
$query="SELECT * FROM specification where nomer=14";
$result=mysql_query($query);
...
include("dbinfo.inc.php");
mysql_query("SET NAMES UTF8");
$query="SELECT * FROM specification wh";
$result=mysql_query($query);
...
echo "<b>No.: $nomer </b><br>ПОЛЕ $pole<br>ТИП $tip<br>РАЗМЕР $razmer<br>Стойност $stoinost<br><hr><br>";
